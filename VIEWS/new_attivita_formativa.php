        ...
        <div class="row my-3 px-4">
            ...
            <div class="input-group py-2">
                <input name="settore" type="text" class="form-control" placeholder="Settore"
                    aria-label="Inserimento nome settore">
            </div>
            <div class="input-group py-2">
            ...
            <div class="input-group py-2">
                <input name="TAF_Ambito" type="text" class="form-control" placeholder="TAF ambito"
                    aria-label="Inserimento TAF ambito">
            </div>
            <div class="input-group py-2">
            ...
            <div class="input-group py-2">
                <input name="semestre" type="text" class="form-control" placeholder="Semestre"
                    aria-label="Inserimento del semestre">
            </div>
            <div class="input-group py-2">
                <input name="descrizione_semestre" type="text" class="form-control"
                    placeholder="Descrizione del semestre" aria-label="Inserimento della descrizione del semestre">
            </div>
            <div class="input-group py-2">
                <input name="anno1" name="descrizione_semestre" type="text" class="form-control" placeholder="Anno 1"
                    aria-label="Inserimento dell'anno 1">
            </div>
            <div class="input-group py-2">
                <input name="anno2" type="text" class="form-control" placeholder="Anno 2"
                    aria-label="Inserimento dell'anno 2">
            </div>
        </div>
